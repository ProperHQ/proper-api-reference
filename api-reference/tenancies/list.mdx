...
<ResponseField name="tenancies" type="Array of Tenancy Objects">
  ...
  <Expandable title="properties of Tenancy Object">

    <ResponseField name="tenancy" type="Tenancy Object">

      <Expandable title="Properties of the Tenancy Object">
      ...
      <ResponseField name="id" type="string">
        ...
        <ResponseField name="address" type="Address Object">
          ...
          <Expandable title="properties of Address Object">
            ...
            <ResponseField name="floor" type="nullable string">
              The floor of the address if applicable
            </ResponseField>

            <ResponseField name="door" type="nullable string">
              The door of the address if applicable
            </ResponseField>

            <ResponseField name="subdivision" type="nullable string">
        ...
        <ResponseField name="currentLease" type="nullable Current Lease Object">
          ...
          <Expandable title="properties">
            ...
            <ResponseField name="contractPeriodState" type="nullable string">
              The state of the contract period (e.g., "Active")
            </ResponseField>

            <ResponseField name="primaryTenantContactName" type="nullable string">
            ...
            <ResponseField name="associatedContactIds" type="nullable Array of string">
              The identifiers for the associated contacts
            </ResponseField>

            <ResponseField name="primaryTenantId" type="nullable string">
              The identifier for the primary tenant
            </ResponseField>

            <ResponseField name="billingContactId" type="nullable string">
            ...
            <ResponseField name="contractStart" type="nullable date">
              The start date of the contract in ISO 8601 format
            </ResponseField>

            <ResponseField name="contractEnd" type="nullable date">
              The end date of the contract in ISO 8601 format
            </ResponseField>

            <ResponseField name="purpose" type="nullable string">
              The purpose of the lease (e.g., "key:residential")
            </ResponseField>

            <ResponseField name="monthlyRentLevel" type="nullable Amount Object">
            ...
            <ResponseField name="archivedAt" type="nullable datetime">
        ...
        <ResponseField name="unitType" type="nullable string">
          The type of the unit (e.g., "PARKING")
        </ResponseField>

        <ResponseField name="unitTypeName" type="nullable string">
          The description of unit type, if unit type is "OTHER"
        </ResponseField>

        <ResponseField name="roomCounts" type="nullable Array of Room Count Objects">
        ...
        <ResponseField name="totalArea" type="nullable Area Object">
        ...
        <ResponseField name="businessArea" type="nullable Area Object">
